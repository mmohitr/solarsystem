...
void draw(void)
{
   ...
   glEnable(GL_COLOR_MATERIAL);
	...
	glRasterPos3f(-1.2, 2.0, 0.0);
	glColor3f(1.0,1.0,1.0);
	writeBitmapString(GLUT_BITMAP_HELVETICA_12, "MOON");
       glPopMatrix();
...
glPushMatrix();
	glRasterPos3f(-1.2, 3.0, 0.0);
	glColor3f(1.0,1.0,1.0);
	writeBitmapString(GLUT_BITMAP_HELVETICA_12, "ASTEROID BELT");
       glPopMatrix();
